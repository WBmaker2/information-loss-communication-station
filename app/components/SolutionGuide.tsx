...
const SOLUTION_STEPS = [
  ...
  {
    title: "달라진 말을 눌러요",
    body: "빠진 말은 이전 문장에서, 새로 생긴 말은 다음 문장에서 눌러요.",
  },
  {
    title: "변화 모습을 골라요",
    body: "내용이 빠짐, 없던 내용이 생김, 뜻이 바뀜, 같은 뜻 중 하나를 골라요.",
  },
  {
    title: "문장 속 근거를 골라요",
    body: "왜 그렇게 생각했는지 보여 주는 말을 골라요. 근거는 ‘이유가 되는 말’이에요.",
  },
  {
    title: "내 답을 확인해요",
    body: "맞으면 다음 단계로 가요. 틀려도 괜찮아요. 고른 말을 다시 살펴보면 돼요.",
  },
];
